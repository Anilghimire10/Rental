...
async function main() {
  ...
  if (!existingFaqs || existingFaqs.length === 0) {
    await db.from("faqs").insert([
      { category: "Listing", question: "Is it free to list my property?", answer: "Yes — listing on GharBhada is completely free. No listing or subscription fees.", sort_order: 0 },
      { category: "Listing", question: "Will renters see my phone number?", answer: "No. We are a mediator — your contact details and exact address are never shown publicly.", sort_order: 1 },
      { category: "Renting", question: "How do I rent a property I like?", answer: "Open the listing and tap “Send inquiry” or “Request a visit”. Our team connects you with the owner.", sort_order: 2 },
      { category: "Renting", question: "Why is the location approximate?", answer: "For safety, the map shows an approximate area, not the exact pin. The address is shared once we connect you.", sort_order: 3 },
      { category: "Account", question: "Can one account rent and list?", answer: "Yes. One account lets you both browse homes and list your own property.", sort_order: 4 },
    ]);
  }
